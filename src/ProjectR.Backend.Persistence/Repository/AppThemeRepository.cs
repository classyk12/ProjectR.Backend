...
namespace ProjectR.Backend.Persistence.Repository
{
    public class AppThemeRepository : IAppThemeRepository
    {
        ...
        {
            List<AppTheme> entities = appThemes.Select(c => new AppTheme { Name = c.Name }).ToList();
        ...
        {
            AppTheme entity = new() { Id = appTheme.Id, Name = appTheme.Name };
        ...
        {
            List<AppTheme> entities = appThemes.Select(c => new AppTheme { Id = c.Id, Name = c.Name }).ToList();
