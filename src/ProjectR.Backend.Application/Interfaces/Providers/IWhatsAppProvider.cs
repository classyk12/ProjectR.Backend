...
namespace ProjectR.Backend.Application.Interfaces.Providers
{
    public interface IWhatsAppProvider
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<bool> SendInteractiveReplyButtonMessageAsync(InteractiveMessageModel model);
    }
}
